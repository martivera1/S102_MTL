...
const Card = () => {
  return (
    <div className='flex bg-white rounded-3xl mx-32 my-20 flex-col font-roboto max-w-3xl'>
        ...
        <div className='flex align-middle justify-center items-center flex-col'>
            ...
            <div className='flex'>
                <button className='bg-blue-600 rounded-lg px-12 py-1.5 text-white mr-4 mb-6 hover:bg-blue-700'>PDF File</button>
                <button className='bg-blue-600 rounded-lg px-12 py-1.5 text-white ml-4 mb-6 hover:bg-blue-700'>Video File</button>
            </div>
        </div>

...
const Card = () => {
  return (
    <div className='flex bg-white rounded-3xl mx-32 my-20 flex-col font-roboto max-w-5xl'>
        <input type="text" placeholder='Paste Link...' className='bg-grey mt-12 bg-slate-300 px-3 rounded-md mx-12 mb-8 h-8 outline-none'/>
        ...
        <div className='align-middle justify-center bg-slate-300 overflow-y-auto max-h-72 mb-8 mx-12 rounded-lg'>
